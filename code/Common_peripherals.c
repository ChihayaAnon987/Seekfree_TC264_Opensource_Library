...
void Encoder_Get()
{
    ...
    FilterPoint_Lat += GpsSpeed * cos((angle[2] + Delta_Angle)* PI / 180) * METER_TO_LAT * 0.005f;
    FilterPoint_Lon += GpsSpeed * sin((angle[2] + Delta_Angle)* PI / 180) * METER_TO_LON * 0.005f;
}
